...
{"A flagstone patio adds timeless charm to any outdoor space, offering endless design possibilities. With its natural textures and customizable shapes, you can create anything from a cozy garden retreat to an elegant entertainment area. This versatile choice pairs beautifully with fire pits, water features, and lush greenery, transforming your yard into a unique, personal oasis."}
</p>
</div>
</div>
<div
...
{"What type of walkways can you do?"}
</Text>
<Box
...
{"We can do pavers, flagstone patios, or brick patios/walkways. There are endless options of hardscape designs to enhance your homes curb appeal with real stone or brick! "}
</p>
</div>
</AccordionContent>
</AccordionItem>
...
<Text
className={`w-text cn7k83s ch7xx7z c8d36da c82qwqc`}>
{"How long does it take to install a new patio or walkway?"}
</Text>
<Box
className={`w-box cx79vvm c4pie2e c2shfwq c1lq6pq8 c60ws42 c1x35ah3 c1fof65s c1kl0qlc c3su6au`}>
<HtmlEmbed
...
<p
className={`w-element ch7xx7z c1v90cn6 c115nxwc c1lwn44j c1fjww6l`}>
{"Adding a hardscape feature to your home is hard work. Depending on the scope of work most jobs are completed in 3 days with some being shorter and some being much longer. Much depends on the design and we will help guide you through the best options for your home based on your wants and budget. Call us to help you through the design and install process of your new hardscape!"}
</p>
</div>
</AccordionContent>
</AccordionItem>
...
<Image
src={"https://cms.improveitmd.com/uploads/porch_and_stone_1_T_Uzs_xl5h_Rvbtd_TCJ_LH_32f056d2d6.jpg"}
width={1500}
height={1118}
alt={"porch and stone"}
loading={"eager"}
...
className={`w-element cqdbcb3 c36uo35 ${"swiper-slide is-service"}`}>
<Image
src={"https://cms.improveitmd.com/uploads/IMG_0209_Qsr_MKO_Vou_C_Of_FJ_5bo_Voi_Q_0ee5ff299e.jpg"}
width={960}
height={720}
alt={"Flagstone Patios and Walkways"}
loading={"eager"}
className={`w-image c139pwc6 c1hwvjgs cdmu5h7 czbu68a cjkauba`} />
</div>
<div
className={`w-element cqdbcb3 c36uo35 ${"swiper-slide is-service"}`}>
<Image
src={"https://cms.improveitmd.com/uploads/73_C385_C0_1739_4_E07_9275_DCE_8_E3_ED_44_C8_1_zz_94_Rw5_Esg_O_Xn_Wb3_G7_Ry_50283db1ed.jpg"}
width={990}
height={1320}
alt={"Walkway"}
loading={"eager"}
...
{"Flagstone Patio and Flagstone Pavers"}
</h2>
<div
className={`w-element c1numhkq c1a06u5s c1s88tz3`}>
<div
...
<p
className={`w-element cn5qs21 c1b2b7rn c82qwqc c1lwn44j c1fjww6l c1g3mhtg`}>
{"Available in earthy shades like browns, grays, and reds, which blend well with outdoor settings."}
</p>
</div>
<div
className={`w-element c1numhkq c1a06u5s c1ym9r0h c1bloln8 casp2qg c1eu6l07 ctjj4no cbtevxf c1ju8duk`}>
...
<p
className={`w-element cn5qs21 c1b2b7rn c82qwqc c1lwn44j c1fjww6l c1g3mhtg`}>
{"Naturally irregular or cut to shape, allowing for custom designs and patterns."}
</p>
</div>
<div
className={`w-element c1numhkq c1a06u5s c1ym9r0h c1bloln8 casp2qg c1eu6l07 ctjj4no cbtevxf c1ju8duk`}>
...
<p
className={`w-element cn5qs21 c1b2b7rn c82qwqc c1lwn44j c1fjww6l c1g3mhtg`}>
{"Resistant to weather and wear, making them ideal for high-traffic areas. Their textured surface provides excellent traction, even when wet."}
</p>
</div>
</div>
</div>
...
<Image
src={"https://cms.improveitmd.com/uploads/IMG_9278_FCE_Gm0_M_Wkr7_Nj_Va_Z_On_Tx_46e9803bc4.jpg"}
width={960}
height={720}
alt={"Flagstone Patios and Walkways"}
loading={"lazy"}
...
{"Flagstone Pavers in MD, VA, and Washington DC"}
</h2>
<h3
className={`w-element c1lsnlld c19fqb9a c82qwqc c1pjr8f cp0czxx c8mqd8h c13bl3hn`}>
{"Flagstone pavers an attractive, practical choice for patios, walkways, and pool surrounds."}
</h3>
<p
className={`w-element cn5qs21 c1b2b7rn c82qwqc c1lwn44j c1fjww6l c1g3mhtg`}>
{"A flagstone patio is a fantastic way to elevate a small outdoor space in DC, creating a cozy retreat that reflects the city’s historic charm. With its natural stone texture and earthy hues, flagstone complements DC's classic architectural style while making even compact spaces feel inviting. Its customizable shapes and layouts allow you to create intimate seating areas, perfect for relaxing or entertaining in a limited area. Paired with lush greenery or classic wrought-iron furniture, a "}
<Link
href={"/locations/washington-dc"}
target={"_self"}
className={`w-element cprvrz2 c1uaxhv2 cacmu18 c1ezjj73 cahz6x0 cmchden`}>
{"flagstone patio in DC"}
</Link>
{" adds elegance and warmth, maximizing your outdoor area’s potential and enhancing its timeless, local character."}
</p>
</div>
</div>
</div>
