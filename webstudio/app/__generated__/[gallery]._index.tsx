...
{Object.entries(
  // @ts-ignore
  Gallery?.data?.data?.galleries ?? {}
).map(([_key, collectionItem]: any) => {
  const collectionItemKey = Array.isArray(Gallery?.data?.data?.galleries) ? Number(_key) : _key;
  return (
...
<Image
src={"https://cms.improveitmd.com/uploads/icon_photo_gallery_P_Xj_U0t_AR_8s_U_Kat_L9_J_Ef_y_68763d674c.svg"}
width={24}
height={24}
