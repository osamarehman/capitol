...
let VideosData = useResource("VideosData_1")
return <Body
className={`w-element`}>
<Box
...
<div
className={`w-element c4vc9qx c9tjkc5 cejishl ckyl1t1 c7iyr7r cmpwmbp cmy3513 cio262d c1gsohh9 c1kqjux0`}>
<div
className={`w-element c139pwc6 caeuris c5ftqtp c1ux94pn`}>
<div
className={`w-element c1numhkq c1a06u5s c15kiuw7 ct0qrmw c1pit5s0 c3qgmhh c1rxyz1p cc29gav c1lzxrwn c164730d`}>
<YouTube
loading={"eager"}
showRelatedVideos={false}
url={VideosData?.data?.data?.videos?.[0]?.videoLink}
className={`w-you-tube c1epvuph cofe5s9 c139pwc6`}>
<VimeoPreviewImage
alt={VideosData?.data?.data?.videos?.[0]?.videoThumbnail?.alternativeText}
sizes={"100vw"}
optimize={true}
loading={"eager"}
...
className={`w-play-button cnbug7k coz31md cqwu05a ccgl4y2 cag2zqh c1rmf1pr c8a631b c1numhkq c1diokdk ch3nxmx c13qspjq c1cqma02 c1yhof13 c1jvw4nv cobnwx1 c13fkmfi c1vf04wj cirjhlt c1d7h9xn c40yumu cz6rnt2 ciuj5m3 cohkcaq c124yypu`}>
<div
aria-hidden={true}
className={`w-element c1b33nw3 c1mu35w6`}>
<HtmlEmbed
code={"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 640 640\"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d=\"M187.2 100.9C174.8 94.1 159.8 94.4 147.6 101.6C135.4 108.8 128 121.9 128 136L128 504C128 518.1 135.5 531.2 147.6 538.4C159.7 545.6 174.8 545.9 187.2 539.1L523.2 355.1C536 348.1 544 334.6 544 320C544 305.4 536 291.9 523.2 284.9L187.2 100.9z\" fill=\"currentColor\"/></svg>"}
className={`w-html-embed`} />
</div>
</VimeoPlayButton>
</YouTube>
...
{VideosData?.data?.data?.videos?.[0]?.title}
</h1>
<p
className={`w-element c309ipl`}>
{VideosData?.data?.data?.videos?.[0]?.punchLine}
</p>
<div
className={`w-element`}>
<HtmlEmbed
code={VideosData?.data?.data?.videos?.[0]?.videoCopy}
className={`w-html-embed c1tm0t1i c1ib9ypd cja62bv c186p1g5 c1jug6p4 cdhj3g4 c1jb6d19 c17yx8ky cu5nasq c1ahb3vt chrba08 c3uip9o c1lr4w14 c101kg50 c1rxi6wi cu0q8sk c1pag8e5 c1pt3uao c1c9efyk c1cyj4m4 cwwcoih c1tfgo8d c4hp6bu cq7cy6g c3ov2p9 c1dqk3pb c14l4quu c10h9ocv`}>
</HtmlEmbed>
</div>
</div>
</div>
