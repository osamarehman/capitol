...
<HtmlEmbed
code={"<video autoplay muted loop playsinline class=\"bg-video\">\n    <source src=\"https://res.cloudinary.com/ddeeo6usc/video/upload/v1766920677/65a0ba3afbb01e16898cbf48_CapitolImprovements_Roofing_LP_d0jzul.mp4\" type=\"video/mp4\">\n    Your browser does not support the video tag.\n  </video>"}
clientOnly={true}
className={`w-html-embed`} />
}
{(LandingPagesData?.data?.data?.lp?.[0]?.backgroundVideoFlatRoofing) &&
<HtmlEmbed
code={"<video fetchpriority=\"high\" autoplay muted loop playsinline class=\"bg-video\">\n    <source src=\"https://res.cloudinary.com/ddeeo6usc/video/upload/v1768162847/65baaaf22ae54c8c249dcda0_CapitolImprovements_Flat-Roofing_LP_3_vmbzrd.mov\" type=\"video/webm\">\n    Your browser does not support the video tag.\n  </video>"}
clientOnly={true}
className={`w-html-embed`} />
}
