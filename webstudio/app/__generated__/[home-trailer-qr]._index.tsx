...
import { Link as Link, Link as Link_1, Body as Body, Form as Form } from "@webstudio-is/sdk-components-react-router";
...
className={`w-element cvfl1ur`}>
<div
className={`w-element c1w6bab8 c8hn21d csaxcaf c1kqjux0 cmf23bd cio262d`}>
<div
className={`w-element c4vc9qx c9tjkc5 c7iyr7r cmpwmbp`}>
<div
className={`w-element c5ftqtp c1ux94pn c139pwc6 c1acxxi0`}>
<div
className={`w-element c1numhkq c1a06u5s c15kiuw7 ct0qrmw c1p4xat6`}>
<div
className={`w-element c1numhkq c1a06u5s c15kiuw7 ct0qrmw c1krf5e c1ogwt2d cuxppy3 cq4o19h c182jog4`}>
<h1
...
<p
className={`w-element c1gcrf2e c8d36da c1g3mhtg ck6awsc cmp92qd`}>
{"We're exterior home remodelers providing quality products, expert installation, and lifetime manufacturer backed warranties. All for a fair price."}
</p>
</div>
<div
className={`w-element c139pwc6`}>
<Image
...
<div
className={`w-element c139pwc6 c10jazik c6h9sty`} />
<div
className={`w-element c139pwc6 caeuris c5ftqtp c1ux94pn`}>
<div
...
<HtmlEmbed
code={"<script>\ndocument.addEventListener(\"DOMContentLoaded\", function() {\n  const videoWrap = document.querySelector(\".hero-video-wrapper\");\n  const video = videoWrap.querySelector(\".hero-video\");\n\n  video.addEventListener(\"ended\", function () {\n    videoWrap.style.display = \"none\";\n  });\n});\n</script>\n\n<script>\n  document.addEventListener(\"DOMContentLoaded\", function () {\n    const readMoreBtn = document.querySelector(\".read-more-toggle\");\n    const hiddenContent = document.querySelector(\".read-more-content\");\n\n    readMoreBtn.addEventListener(\"click\", () => {\n      hiddenContent.classList.add(\"is-visible\"); // fade-in animation\n      readMoreBtn.style.display = \"none\"; // hide read-more forever\n    });\n  });\n</script>\n\n"}
clientOnly={true}
className={`w-html-embed`} />
</Box>
</Body>
