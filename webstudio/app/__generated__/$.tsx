...
return <Body
className={`w-element c1numhkq ch3nxmx c1diokdk cs0hfs4`}>
<div
className={`w-element`}>
<div
className={`w-element c1epvuph c1p4xat6 cbz4sys c16h8dz1 c18mkjfw cpc7um1`}>
<div
className={`w-element`}>
{"404"}
</div>
<div
className={`w-element cnbug7k c2d6ize c1tlc0tf c9wdz4b c12hfwxi cl2x1qv`}>
{"404"}
</div>
<div
className={`w-element cnbug7k c2d6ize c1jj5u1i c9wdz4b c1awiikd cl2x1qv`}>
{"404"}
</div>
<div
className={`w-element cnbug7k ccgl4y2 cp1dmkc c139pwc6 cs0hfs4 c1v7ylm3`} />
</div>
<p
className={`w-element c4izu12 c1pjr8f c18v83wh c9sojpi crxn48q`}>
{"PAGE NOT FOUND"}
</p>
</div>
<Link
