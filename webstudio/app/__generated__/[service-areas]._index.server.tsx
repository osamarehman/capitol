...
export const getResources = (_props: { system: System }) => {
  ...
  return {
    title: "Capitol Improvements - Service Area - Maryland, Washington, DC and Northern Virginia",
    description: "As one of Maryland, Washington, DC and Virginia's best roofing, siding, gutter, window, deck builders, and door contractors chances are we have a job in your neighborhood. ",
