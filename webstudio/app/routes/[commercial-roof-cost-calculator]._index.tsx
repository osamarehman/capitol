...
import {
  ...
  breakpoints,
} from "../__generated__/[commercial-roof-cost-calculator]._index";
import {
  getResources,
  getPageMeta,
  getRemixParams,
  contactEmail,
} from "../__generated__/[commercial-roof-cost-calculator]._index.server";
  ...
  metas.push({
    "script:ld+json": {
      ...
      "@graph": [
        {
          "@type": "WebApplication",
          "@id": "https://improveitmd.com/commercial-roof-cost-calculator#webapp",
          "name": "Commercial Roof Cost Calculator - Capitol Improvements",
          "url": "https://improveitmd.com/commercial-roof-cost-calculator",
