...
import {
  ...
  breakpoints,
} from "../__generated__/[locations].[gaithersburg]._index";
import {
  getResources,
  getPageMeta,
  getRemixParams,
  contactEmail,
} from "../__generated__/[locations].[gaithersburg]._index.server";
      ...
      "@graph": [
        {
          ...
          "hasMap": "https://www.google.com/maps/place/Capitol+Improvements/@39.1434,-77.2014",
