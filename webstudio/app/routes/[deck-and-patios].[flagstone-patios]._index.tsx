...
import {
  ...
  breakpoints,
} from "../__generated__/[deck-and-patios].[flagstone-patios]._index";
import {
  getResources,
  getPageMeta,
  getRemixParams,
  contactEmail,
} from "../__generated__/[deck-and-patios].[flagstone-patios]._index.server";
  ...
  metas.push({
    "script:ld+json": {
      ...
      "@graph": [
        {
          "@type": "Service",
          "@id": "https://improveitmd.com/deck-and-patios/flagstone-patios#service",
          "name": "Flagstone Patios - Capitol Improvements",
          "url": "https://improveitmd.com/deck-and-patios/flagstone-patios",
