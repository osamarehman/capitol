...
// Source: app/__generated__/[roofing]._index.tsx
...
import { Box as Box, Slot as Slot, HtmlEmbed as HtmlEmbed, Image as Image, Button as Button, Text as Text, Fragment as Fragment_1 } from "@webstudio-is/sdk-components-react/components";
import { Link as Link, Link as Link_1 } from "@webstudio-is/sdk-components-react-router";
...
export const SiteHeader = () => (
  <ChromeProvider>
    ...
    <Image
    alt={"Logo Icon"}
    src={"https://improveitmd.com/uploads/capitol_improvements_logo_mui4_YFXS_Pv_M_Ej33_G1_Ey_WT_8932b99c78.svg"}
    width={18}
    height={12}
    loading={"eager"}
    className={`w-image cqsaj3r c11y8oun ctpsi40 c12l5srj`} />
    <Image
    src={"https://improveitmd.com/uploads/capitol_improvements_logo_text_Il_Lf_LABIT_im_V1n_R5_Dx_Y3_f89681a688.svg"}
    width={161}
    height={8}
    alt={"Logo Text"}
    loading={"eager"}
    ...
    <Image
    src={"https://improveitmd.com/uploads/capitol_improvements_logo_main_Nd_E_Tm_Jnbu_Uj_H_Kf4_92i4_55ce0081f9.svg"}
    width={151}
    height={30}
    alt={""}
    loading={"eager"}
