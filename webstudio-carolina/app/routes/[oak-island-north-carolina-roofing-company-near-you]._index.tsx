...
import {
  ...
  breakpoints,
} from "../__generated__/[oak-island-north-carolina-roofing-company-near-you]._index";
import {
  getResources,
  getPageMeta,
  getRemixParams,
  contactEmail,
} from "../__generated__/[oak-island-north-carolina-roofing-company-near-you]._index.server";
              ...
              "@graph": [
                    {
                          ...
                          "url": "https://improveitcarolina.com"
                    },
                    {
                          "@type": "HomeAndConstructionBusiness",
                          "@id": "https://improveitcarolina.com/#corporation",
                          "name": "Capitol Family Exteriors",
                          "url": "https://improveitcarolina.com",
...
const Outlet = () => {
  ...
  return (
    ...
    >
      ...
      <PageSettingsCanonicalLink href={`https://improveitcarolina.com${new URL(url).pathname}`} />
    </ReactSdkContext.Provider>
  );
};
