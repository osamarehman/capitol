...
let JamesHardieCollectionData = useResource("JamesHardieCollectionData_1")
return <Body
className={`w-element`}>
<Box
data-jh-color={JamesHardieColorData?.data?.data?.jamesHardie?.[0]?.colorBackground}
...
{(JamesHardieColorData?.data?.data?.jamesHardie?.[0]?.sliderImage1?.url ? true : false) &&
<div
...
{(JamesHardieColorData?.data?.data?.jamesHardie?.[0]?.sliderImage2?.url ? true : false) &&
<div
className={`w-element c139pwc6 c18bj3o3 c1lq6pq8 c1epvuph ${"swiper-slide"}`}>
<Image
loading={"eager"}
...
{(JamesHardieColorData?.data?.data?.jamesHardie?.[0]?.sliderImage3?.url ? true : false) &&
<div
className={`w-element c139pwc6 c18bj3o3 c1lq6pq8 c1epvuph ${"swiper-slide"}`}>
<Image
loading={"eager"}
...
{(JamesHardieColorData?.data?.data?.jamesHardie?.[0]?.sliderImage4?.url ? true : false) &&
<div
className={`w-element c139pwc6 c18bj3o3 c1lq6pq8 c1epvuph ${"swiper-slide"}`}>
<Image
loading={"eager"}
...
{(JamesHardieColorData?.data?.data?.jamesHardie?.[0]?.sliderImage5?.url ? true : false) &&
<div
className={`w-element c139pwc6 c18bj3o3 c1lq6pq8 c1epvuph ${"swiper-slide"}`}>
<Image
loading={"eager"}
...
{(JamesHardieColorData?.data?.data?.jamesHardie?.[0]?.sliderImage6?.url ? true : false) &&
<div
className={`w-element c139pwc6 c18bj3o3 c1lq6pq8 c1epvuph ${"swiper-slide"}`}>
<Image
loading={"eager"}
...
{JamesHardieColorData?.data?.data?.jamesHardie?.[0]?.sliderHeading}
</p>
<p
className={`w-element c1g3mhtg`}>
{JamesHardieColorData?.data?.data?.jamesHardie?.[0]?.subHeading}
</p>
</div>
<div
className={`w-element c1a06u5s c3qgmhh c1pit5s0`}>
<HtmlEmbed
code={JamesHardieColorData?.data?.data?.jamesHardie?.[0]?.sliderDetail}
className={`w-html-embed c132nttf cbddvez cp277i2 cgqh2e c1tb6avz cnwe5rt cx7wnbu`}>
</HtmlEmbed>
</div>
</div>
</div>
...
<p
className={`w-element c309ipl cn7k83s`}>
{JamesHardieColorData?.data?.data?.jamesHardie?.[0]?.ctaName}
</p>
<p
className={`w-element c309ipl`}>
{JamesHardieColorData?.data?.data?.jamesHardie?.[0]?.ctaText}
</p>
</div>
</div>
<Link_1
href={"/quote"}
target={"_self"}
className={`w-link c1lvj0n c1t6vvls cpxswal cacmu18 c1numhkq c1u81kxm c1v2l8nt c1diokdk ch3nxmx cxw1g6g cn7k83s c1d8rs8t c5mb4u7 cx6mbsi c1vzqn6x csubbc2 ccmxen3 c1obobqc c1wygun7 c1rgg99s c1r2737e cgtmmxo c1cukx3 c3su6au c13qspjq c1cqma02 c1jvw4nv c1yhof13 c8d36da c1rayu5r c10lg9mv cahz6x0 cmchden c1ou92f6 c10iz0pl c5g53jj cba5e3y c12uktu2 c15gxmz4 ce7eq67 ctsgeyf c1plys2`}>
...
className={`w-element`}>
<div
className={`w-element c1numhkq c1a06u5s c169jguh c1gijf1r`}>
{Object.entries(
  // @ts-ignore
  JamesHardieCollectionData?.data?.data?.jamesHardie ?? {}
).map(([_key, JamesHardieColorItem]: any) => {
  const index = Array.isArray(JamesHardieCollectionData?.data?.data?.jamesHardie) ? Number(_key) : _key;
  return (
<Fragment key={index}>
<div
data-load={""}
className={`w-element`}>
<Link
href={JamesHardieColorItem?.slug}
data-jh-swatch={JamesHardieColorItem?.colorBackground}
className={`w-element c139pwc6 cjkauba c1s18yzb c18mkjfw chxc8gf c1g3mhtg cacmu18 c1w9fs99 c1t8k3l9 c1hwvjgs co5u01l c10sfw4k cizmntn`}>
<p
data-color-switch={JamesHardieColorItem?.colorDarkWhiteForSwatches}
className={`w-element cw8t5ou`}>
...
<HtmlEmbed
code={JamesHardieColorData?.data?.data?.jamesHardie?.[0]?.featureHeadingText1}
className={`w-html-embed c1pgvi0o c1dk6ilb c1g0pfrk c1eqn05n cx7wnbu cjgoiwu cmgvp6y c1hqutl1 c1w7sn6e c15wbc3l cpt7she c19pydqo cojmhy2`}>
</HtmlEmbed>
</div>
<div
...
className={`w-element c6majsq c13g3obg`}>
<HtmlEmbed
code={JamesHardieColorData?.data?.data?.jamesHardie?.[0]?.featureHeadingText2}
className={`w-html-embed c1pgvi0o c1dk6ilb c1g0pfrk c1eqn05n cx7wnbu cjgoiwu cmgvp6y c1hqutl1 c1w7sn6e c15wbc3l cpt7she c19pydqo cojmhy2`}>
</HtmlEmbed>
</div>
<div
...
className={`w-element c6majsq c13g3obg`}>
<HtmlEmbed
code={JamesHardieColorData?.data?.data?.jamesHardie?.[0]?.featureHeadingText3}
className={`w-html-embed c1pgvi0o c1dk6ilb c1g0pfrk c1eqn05n cjgoiwu cmgvp6y c1hqutl1 c1w7sn6e c15wbc3l cpt7she c19pydqo cojmhy2 cx7wnbu`}>
</HtmlEmbed>
</div>
<div
className={`w-element c1epvuph c1numhkq`}>
...
{"“I was very happy with the work of Capitol Improvements. I replaced 21 very old windows and it completely modernized my house when they were done. Higly recommend this company.”"}
</p>
<div
...
{Object.entries(
  // @ts-ignore
  JamesHardieCollectionData?.data?.data?.jamesHardie ?? {}
).map(([_key, JamesHardieColorItem_1]: any) => {
  const index_1 = Array.isArray(JamesHardieCollectionData?.data?.data?.jamesHardie) ? Number(_key) : _key;
  return (
<Fragment key={index_1}>
<div
className={`w-element`}>
<Link
href={JamesHardieColorItem_1?.slug}
data-jh-swatch={JamesHardieColorItem_1?.colorBackground}
className={`w-element c139pwc6 cjkauba c1s18yzb c18mkjfw chxc8gf c1g3mhtg cacmu18 c1w9fs99 c1t8k3l9 c1hwvjgs co5u01l c10sfw4k cizmntn`}>
<p
data-color-switch={JamesHardieColorItem_1?.colorDarkWhiteForSwatches}
className={`w-element cw8t5ou`}>
{JamesHardieColorItem_1?.colorName}
</p>
</Link>
</div>
</Fragment>
