...
export const getResources = (_props: { system: System }) => {
  ...
  return {
    ...
    description: "Explore CAPITOL's legacy: Over 30 years of family-run excellence in serving clients. Expertise and fairness in every project. Free estimates available.",
