/* eslint-disable */
      ...
      import { Fragment as Fragment_1, Box as Box, Slot as Slot, HtmlEmbed as HtmlEmbed, Image as Image, Button as Button, Text as Text, Time as Time } from "@webstudio-is/sdk-components-react";
...
className={`w-element c139pwc6 caeuris c5ftqtp c1ux94pn`}>
<div
className={`w-element c1numhkq c1a06u5s c15kiuw7 ct0qrmw c1t4g0yi cykbfry c876kpt cc29gav c1rxyz1p c1t9puix c1lzxrwn c135vs31 c5d3i40 c5v4dmg czr9sbv`}>
<h1
...
<div
className={`w-element c876kpt cc29gav c5d3i40 c1n30c32 c1br65qh`}>
<div
className={`w-element cmsm1bz c1pit5s0 c1czy0yv c1omlw60 c1txodcv c1t86vhp c10bzxv c1dqrbr9 cdhpo3y c19koxyq`}>
{Object.entries(
  // @ts-ignore
  BlogsCollectionData?.data?.data?.carolinaBlog ?? {}
).map(([_key, blogsItem]: any) => {
  const index = Array.isArray(BlogsCollectionData?.data?.data?.carolinaBlog) ? Number(_key) : _key;
  return (
<Fragment key={index}>
<div
className={`w-element`}>
<Link
href={system?.origin + system?.pathname + "/" + blogsItem?.slug}
...
<div
className={`w-element c1numhkq c1a06u5s c1bloln8 c1lea6ge c16xcwo5`}>
<Time
dateTime={blogsItem?.publishedDateShown}
country={"US"}
className={`w-time`} />
<Link
href={system?.origin + system?.pathname + "/" + blogsItem?.slug}
className={`w-element c82qwqc czl7eu5`}>
<h2
className={`w-element c1pjr8f c1lsnlld c19fqb9a c82qwqc cp0czxx c8a9tkm c1r2737e cgtmmxo c1cukx3 c3su6au c8mqd8h c13bl3hn`}>
{blogsItem?.title}
</h2>
</Link>
</div>
