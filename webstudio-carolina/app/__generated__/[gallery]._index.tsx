...
let Gallery = useResource("Gallery_1")
return <Body
className={`w-element`}>
<HtmlEmbed
...
className={`w-element c139pwc6 caeuris c5ftqtp c1ux94pn`}>
<div
className={`w-element cvfl1ur c1numhkq c1a06u5s c1603wqb c15kiuw7 ct0qrmw c1rxyz1p cc29gav co5hy9p c5d3i40 c1lzxrwn c164730d c135vs31 cq9r5tw`}>
<h1
...
{"See some of our recent and featured projects."}
</p>
</div>
<div
className={`w-element cmsm1bz c1pit5s0 c3qgmhh cf50rr5 c1txodcv curgy1m`}>
{Object.entries(
  // @ts-ignore
  Gallery?.data?.data?.carolinaGalleries ?? {}
).map(([_key, collectionItem]: any) => {
  const collectionItemKey = Array.isArray(Gallery?.data?.data?.carolinaGalleries) ? Number(_key) : _key;
  return (
<Fragment key={collectionItemKey}>
<div
className={`w-element c1numhkq cjkauba c1e70mcr c3phgpy c1epvuph cpmlyxd c1r2737e cgtmmxo c1cukx3 c3su6au cumg6ra`}>
<div
className={`w-element cd311gm c1hgk76z c2j7e41 c139pwc6 c1a3m2cy c6fw2b1 c1lvj0n c1d7h9xn cnbug7k c1vue08o c1sz7ez0 c189czh1 c19wpft8`}>
<Image
src={"https://improveitcarolina.com/uploads/icon_photo_gallery_P_Xj_U0t_AR_8s_U_Kat_L9_J_Ef_y_68763d674c.svg"}
width={24}
height={24}
alt={""}
loading={"eager"}
className={`w-image ci9ixvi c1hwvjgs cdmu5h7 czbu68a c1f3bifo`} />
</div>
{(!!collectionItem?.image1?.url
) &&
<Link
...
className={`w-element cvfl1ur`}>
<div
className={`w-element cip7j3i czdtdk8 c1rxa3re`}>
<div
className={`w-element c139pwc6 caeuris c5ftqtp c1ux94pn`}>
<div
