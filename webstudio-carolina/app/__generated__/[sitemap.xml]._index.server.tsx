...
export const getResources = (_props: { system: System }) => {
  ...
  const BlogSitemapData_1: ResourceRequest = {
    ...
    body: {
  "query": "query CarolinaBlog($pagination: PaginationArg) {\n  carolinaBlog(pagination: $pagination) {\n   slug\n    updatedAt\n  }\n}",
  "variables": {
  "pagination": {
    "limit": 100
  }
  ...
  const LandingPagesSitemapData_1: ResourceRequest = {
    ...
    body: {
  "query": "query CarolinaLp($pagination: PaginationArg) {\n  carolinaLp(pagination: $pagination) {\n    slug\n    updatedAt\n  }\n}",
  "variables": {
  "pagination": {
    "limit": 1000
  }
  ...
  const LocalPagesSitemapData_1: ResourceRequest = {
    ...
    body: {
  "query": "query CarolinaServices($pagination: PaginationArg) {\n  carolinaServices(pagination: $pagination) {\n    slug\n    updatedAt\n  }\n}",
  "variables": {
  "pagination": {
    "limit": 1000
  }
